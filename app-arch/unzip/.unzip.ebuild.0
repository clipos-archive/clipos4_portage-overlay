...
IUSE="bzip2 natspec unicode clip-deps"

DEPEND="!clip-deps? ( bzip2? ( app-arch/bzip2 ) )
...
src_prepare() {
	#Correct CVE-2015-015-7696 and CVE-2015-7697
	# patch #23 upstream 
	epatch "${FILESDIR}"/0001-extract-prevent-unsigned-overflow-on-invalid-input.patch
	#Another Patch from RedHat to prevent infinite loop un incorrect bzip
	epatch "${FILESDIR}"/unzip-bz1260944.patch
