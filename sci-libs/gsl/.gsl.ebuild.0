...
# $Header: /var/www/viewcvs.gentoo.org/raw_cvs/gentoo-x86/sci-libs/gsl/gsl-1.13-r1.ebuild,v 1.6 2010/01/30 19:07:33 armin76 Exp $
...
src_install() {
	...
	use !clip && eselect cblas add $(get_libdir) "${FILESDIR}"/eselect.cblas.gsl \
		${ESELECT_PROF}
}
