...
# $Header: /var/cvsroot/gentoo-x86/virtual/perl-digest-base/perl-digest-base-1.170.0-r1.ebuild,v 1.13 2013/03/02 16:39:04 ago Exp $
...
RDEPEND="!clip-deps? ( || ( =dev-lang/perl-5.16* ~perl-core/${PN#perl-}-${PV} ) )"
