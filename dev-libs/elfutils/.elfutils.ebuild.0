...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/elfutils/elfutils-0.154-r1.ebuild,v 1.2 2012/07/22 20:31:47 vapier Exp $
...
IUSE="bzip2 lzma nls static-libs test +threads +utils zlib clip-deps"
...
src_install() {
	...
	use utils || rm -rf "${ED}${CPREFIX:-/usr}"/bin
}
