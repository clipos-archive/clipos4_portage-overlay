...
IUSE="+crypt doc gmp kernel_linux mhash pcre static-libs test xml core-deps"

RDEPEND=">=media-libs/raptor-2.0.7:2
	!core-deps? ( kernel_linux? ( >=sys-apps/util-linux-2.19 ) )
...
src_install() {
	...
	use doc || rm -rf "${ED}${CPREFIX:-/usr}"/share/doc/${PF}/html/rasqal
