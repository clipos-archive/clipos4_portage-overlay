...
IUSE="+ncurses nls static-libs test unicode clip"
...
src_prepare() {
	...
	use clip && epatch "${FILESDIR}/${PN}-3.2.8-clip-noproc.patch"
}
...
pkg_predeb() {
	# CAP_SYS_MODULE (small time window only...)
	doverictld2 /sbin/sysctl er 'SYS_MODULE|SYS_ADMIN' 'SYS_MODULE|SYS_ADMIN' - -
}
