...
# $Header: /var/cvsroot/gentoo-x86/xfce-base/libxfce4ui/libxfce4ui-4.10.0.ebuild,v 1.8 2012/05/22 05:15:51 jdhore Exp $
...
IUSE="debug glade startup-notification clip-deps"

RDEPEND="!clip-deps? ( >=dev-libs/glib-2.24 )
	>=x11-libs/gtk+-2.20:2
	x11-libs/libX11
	x11-libs/libICE
	x11-libs/libSM
