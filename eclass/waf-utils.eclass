...
waf-utils_src_configure() {
	...
	[[ -z ${NO_WAF_LIBDIR} ]] && libdir="--libdir=${EPREFIX}${CPREFIX:-/usr}/$(get_libdir)"

	tc-export AR CC CPP CXX RANLIB
	echo "CCFLAGS=\"${CFLAGS}\" LINKFLAGS=\"${LDFLAGS}\" \"${WAF_BINARY}\" --prefix=${EPREFIX}${CPREFIX:-/usr} ${libdir} $@ configure"
