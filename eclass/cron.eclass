...
inherit eutils flag-o-matic deb

EXPORT_FUNCTIONS pkg_postinst pkg_predeb
...
docrontab() {
	...
	# CLIP: cron is root-only
	use clip && perms="-m 0750 -o root -g root"
