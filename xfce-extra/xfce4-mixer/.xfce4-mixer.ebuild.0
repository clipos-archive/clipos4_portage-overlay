...
IUSE="alsa debug oss clip-deps clip"

COMMON_DEPEND="!clip-deps? ( >=dev-libs/glib-2.24 )
...
RDEPEND="${COMMON_DEPEND}
	clip? ( alsa? ( media-plugins/gst-plugins-alsa010:0.10 ) )
	!clip? ( alsa? ( media-plugins/gst-plugins-alsa:0.10 ) )
