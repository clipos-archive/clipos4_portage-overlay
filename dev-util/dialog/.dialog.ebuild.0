...
# $Header: /var/cvsroot/gentoo-x86/dev-util/dialog/dialog-1.1.20080819.ebuild,v 1.7 2009/03/06 03:23:30 jer Exp $
...
IUSE="examples nls unicode clip-deps clip"

RDEPEND="!clip? ( >=app-shells/bash-2.04-r3 )
	!clip-deps? ( >=sys-libs/ncurses-5.2-r5 )"
DEPEND="${RDEPEND}
