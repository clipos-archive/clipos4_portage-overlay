...
IUSE="doc lapack test clip"

RDEPEND="!clip? ( dev-python/setuptools[${PYTHON_USEDEP}] )
	lapack? ( virtual/cblas virtual/lapack )"
DEPEND="${RDEPEND}
	clip? ( dev-python/setuptools[${PYTHON_USEDEP}] )
	doc? ( app-arch/unzip )
...
python_prepare_all() {
	if use lapack; then
		...
		local libdir="${EPREFIX}${CPREFIX:-/usr}"/$(get_libdir)
