...
IUSE="examples libffi test clip-deps"
...
src_install() {
	installing() {
		...
		use clip || dosym "${prefixed_sitedir#${EPREFIX}}/gtk-2.0/codegen/codegen.py" "/usr/lib/python-exec/${EPYTHON}/pygobject-codegen-2.0"
	}
