...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pillow/pillow-2.5.3-r1.ebuild,v 1.4 2014/11/02 09:04:40 ago Exp $
...
IUSE="doc examples jpeg jpeg2k lcms scanner test tiff tk truetype webp zlib clip-deps"
...
RDEPEND="
	...
	!clip-deps? ( zlib? ( sys-libs/zlib:0= ) )"
DEPEND="${RDEPEND}
	app-arch/unzip
