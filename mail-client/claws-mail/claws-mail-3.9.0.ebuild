...
# $Header: /var/cvsroot/gentoo-x86/mail-client/claws-mail/claws-mail-3.9.0.ebuild,v 1.8 2012/12/31 09:18:49 ago Exp $

EAPI="4"

inherit autotools-utils multilib gnome2-utils eutils verictl2

DESCRIPTION="An email client (and news reader) based on GTK+"
DESCRIPTION_FR="Client de messagerie alternatif"
CATEGORY_FR="Réseau"
...
src_install() {
	...
	#CLIP : remove remaining doc files in /usr/share
...
pkg_predeb() {
	doverictld2  "${CPREFIX:-/usr}/bin/claws-mail" e - - - c
}
