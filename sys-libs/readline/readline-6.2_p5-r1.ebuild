...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/readline/readline-6.2_p5-r1.ebuild,v 1.15 2014/07/28 13:49:34 ago Exp $
...
IUSE="static-libs rm-deps clip"

RDEPEND="!rm-deps? ( >=sys-libs/ncurses-5.9-r3[${MULTILIB_USEDEP}] )
	abi_x86_32? (
