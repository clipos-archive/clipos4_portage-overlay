...
DESCRIPTION_FR="Logiciel avancé de dessin vectoriel SVG"
...
IUSE="${IUSE} lcms clip-deps clip clip-devstation"
...
COMMON_DEPEND="
	${PYTHON_DEPS}
	!clip? ( >=app-text/poppler-0.26.0:=[cairo] )
...
RDEPEND="${COMMON_DEPEND}
	...
	!clip-devstation? ( !clip? ( media-gfx/uniconvertor ) )
	dia? ( app-office/dia )
...
src_install() {
	...
	prune_libtool_files
	python_optimize "${ED}${CPREFIX:-/usr}"/share/${PN}/extensions
}
