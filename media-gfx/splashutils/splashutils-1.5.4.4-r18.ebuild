...
EAPI=5
inherit autotools eutils multilib toolchain-funcs verictl2
...
RESTRICT="test"
IUSE="hardened +png +truetype gpm fbcondecor clip"
...
SRC_URI="
	...
	mirror://sourceforge/libpng/libpng-${V_PNG}.tar.xz
	ftp://ftp.uu.net/graphics/jpeg/jpegsrc.v${V_JPEG}.tar.gz
	mirror://sourceforge/freetype/freetype-${V_FT}.tar.bz2
	http://www.gzip.org/zlib/zlib-${V_ZLIB}.tar.gz
"
...
src_prepare() {
	...
	use clip && epatch "${FILESDIR}/splashutils-1.5.4.4-clip-openrc.patch"
	...
	use clip && epatch "${FILESDIR}/splashutils-1.5.4.4-clip.patch"

	epatch "${FILESDIR}/${P}-bzip2.patch"
	epatch "${FILESDIR}/${P}-zlib-ar.patch"
...
pkg_predeb() {
	# CAP_SYS_TTY_CONFIG inheritable
	doverictld2 /sbin/fbsplashd.static er SYS_TTY_CONFIG - SYS_TTY_CONFIG - 
}
