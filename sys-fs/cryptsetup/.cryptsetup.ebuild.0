...
inherit autotools python-single-r1 linux-info libtool eutils versionator verictl2
...
src_install() {
	...
	use clip && dosym "/sbin/cryptsetup" "/bin/cryptsetup"
...
pkg_predeb() {
		doverictld2 /sbin/cryptsetup er 'MKNOD|SYS_ADMIN' - 'MKNOD|SYS_ADMIN' -
}
