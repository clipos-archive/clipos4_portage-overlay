...
#EAPI="6" CLIP doesn't have EAPI 6 yet, downgrade seems OK 20160519
EAPI="5"
...
RDEPEND="
	...
	clip-devstation? ( sys-apps/portage )
	!clip-devstation? ( sys-apps/portage[${PYTHON_USEDEP}] )"
...
src_prepare() {
	...
	then
		epatch ${FILESDIR}/${PN}-${PV}-clip-ignore-ROOT.patch
	fi
}
