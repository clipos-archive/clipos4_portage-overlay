...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/man-pages/man-pages-3.75.ebuild,v 1.2 2015/01/02 08:56:16 vapier Exp $
...
IUSE="nls ${IUSE_LINGUAS// / linguas_} clip"
RESTRICT="binchecks"

RDEPEND="!clip? ( virtual/man )
...
src_install() {
	emake install prefix="${EPREFIX}${CPREFIX:-/usr}" DESTDIR="${D}"
