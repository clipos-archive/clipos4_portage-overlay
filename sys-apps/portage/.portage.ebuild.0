...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.1.11.31.ebuild,v 1.6 2012/11/16 11:50:25 ago Exp $
...
KEYWORDS="x86 amd64"
SLOT="0"
IUSE="build doc epydoc +ipc linguas_pl pypy1_9 python2 python3 selinux xattr clip-devstation ccsd"
...
RDEPEND="${python_dep}
	...
	clip-devstation? ( 
		>=clip-dev/clip-deb-1.2.6 
		>=clip-dev/clip-devutils-2.1.0
		ccsd? ( clip-dev/ccsd-utils )
		>=sys-kernel/clip-kernel-2.6.28
	)
...
src_prepare() {
	...
	use clip-devstation && epatch "${FILESDIR}/${P}-clip.patch"
	use clip-devstation && epatch "${FILESDIR}/${P}-clip-kernelconfig.patch"
	use clip-devstation && epatch "${FILESDIR}/${P}-disable-restrict-mirror.patch"
