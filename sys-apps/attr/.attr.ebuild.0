...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/attr/attr-2.4.47-r1.ebuild,v 1.14 2014/03/19 13:48:40 ago Exp $
...
multilib_src_install() {
	...
	if multilib_is_native_abi; then
		...
		rm -r "${ED}${CPREFIX:-/usr}"/share/man/man2 || die
	fi
}
