...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/dconf/dconf-0.18.0.ebuild,v 1.10 2014/05/17 15:31:15 ago Exp $

EAPI="5"
GCONF_DEBUG="no"

inherit gnome2 bash-completion-r1 virtualx deb
...
# TODO: coverage ?
IUSE="test +X clip clip-deps"

KEYWORDS="alpha amd64 ~arm ia64 ppc ppc64 ~sh sparc x86 ~x86-fbsd ~arm-linux ~x86-linux"

RDEPEND="
	!clip-deps? ( >=dev-libs/glib-2.35.2:2 ) 
	sys-apps/dbus
	X? (
		>=dev-libs/libxml2-2.7.7:2
		!clip? ( >=x11-libs/gtk+-3.4:3 )
		clip? ( >=x11-libs/gtk+3-3.4:3 )
	)
"
DEPEND="${RDEPEND}
	dev-libs/libxslt
...
src_install() {
	...
	rm -rv "${ED}${CPREFIX:-/usr}/share/bash-completion" || die
