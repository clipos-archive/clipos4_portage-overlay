...
IUSE="afp archive avahi bluetooth bluray cdda fuse gdu gnome-keyring gnome-online-accounts gphoto2 gtk +http mtp ios samba systemd test +udev udisks clip-deps"

# Can use libgphoto-2.5.0 as well. Automagic detection.
RDEPEND="
	!clip-deps? ( >=dev-libs/glib-2.35:2 )
	sys-apps/dbus
	dev-libs/libxml2:2
	net-misc/openssh
...
src_configure() {
	...
	gnome2_src_configure \
		...
		--disable-hal \
		--with-dbus-service-dir=${EPREFIX}${CPREFIX:-/usr}/share/dbus-1/services \
