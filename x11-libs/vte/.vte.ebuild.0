...
IUSE="debug doc glade introspection clip-deps clip"

PDEPEND="x11-libs/gnome-pty-helper"
RDEPEND="!clip-deps? ( >=dev-libs/glib-2.31.13:2 )
	!clip? ( >=x11-libs/gtk+-3.1.9:3[introspection?] )
	clip? ( >=x11-libs/gtk+3-3.1.9:3[introspection?] )
	>=x11-libs/pango-1.22.0

	!clip-deps? ( sys-libs/ncurses )
	x11-libs/libX11
	x11-libs/libXft
...
src_install() {
	gnome2_src_install
	rm -v "${ED}${cPREFIX:-usr}/libexec/gnome-pty-helper" || die
}
