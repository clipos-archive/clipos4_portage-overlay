...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/libXaw3d/libXaw3d-1.6.2.ebuild,v 1.11 2012/07/27 23:16:01 ottxor Exp $
...
PATCHES=( "${FILESDIR}/${PN}-1.6.2-menu-segfault.patch" )
