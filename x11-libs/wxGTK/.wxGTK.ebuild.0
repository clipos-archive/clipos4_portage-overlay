...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/wxGTK/wxGTK-2.8.12.1-r1.ebuild,v 1.1 2013/08/10 06:07:51 dirtyepic Exp $
...
IUSE="X aqua doc debug gnome gstreamer odbc opengl pch sdl tiff clip-deps
core-deps clip"
...
PDEPEND="!clip? ( >=app-admin/eselect-wxwidgets-0.7 )"
...
src_install() {
	...
	local wxmsw="${ED}${cPREFIX:-usr}/share/locale/it/LC_MESSAGES/wxmsw.mo"
	[[ -e ${wxmsw} ]] && rm "${wxmsw}"
}
