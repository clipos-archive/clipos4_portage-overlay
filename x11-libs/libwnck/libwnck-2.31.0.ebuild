...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/libwnck/libwnck-2.31.0.ebuild,v 1.11 2012/12/16 09:04:08 tetromino Exp $
...
IUSE="doc +introspection startup-notification clip-deps"

RDEPEND=">=x11-libs/gtk+-2.19.7:2[introspection?]
	!clip-deps? ( >=dev-libs/glib-2.16:2 )
	x11-libs/libX11
	x11-libs/libXres
	x11-libs/libXext
