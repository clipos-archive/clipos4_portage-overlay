...
# $Header: /var/cvsroot/gentoo-x86/perl-core/Compress-Raw-Zlib/Compress-Raw-Zlib-2.60.0.ebuild,v 1.13 2013/03/02 16:12:31 ago Exp $
...
RDEPEND="!clip-deps? ( >=sys-libs/zlib-1.2.5 )"
DEPEND="${RDEPEND}"
