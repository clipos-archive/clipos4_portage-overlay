...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libexif/libexif-0.6.21-r1.ebuild,v 1.9 2014/08/25 10:59:51 ago Exp $
...
IUSE="doc nls static-libs clip-deps"
...
multilib_src_configure() {
	econf \
		...
		$(use_enable nls) \
		$(use_enable doc docs) \
		--with-doc-dir="${EPREFIX}"${CPREFIX:-/usr}/share/doc/${PF}
}
...
multilib_src_install_all() {
	prune_libtool_files
	rm -f "${ED}"${CPREFIX:-/usr}/share/doc/${PF}/{ABOUT-NLS,COPYING}
}
