...
# $Header: /var/cvsroot/gentoo-x86/media-libs/lcms/lcms-1.19-r2.ebuild,v 1.4 2014/06/23 04:32:42 phajdan.jr Exp $
...
RDEPEND="
	clip? ( >=media-libs/lcms-2.0a )
	tiff? ( >=media-libs/tiff-4.0.3-r6:0[${MULTILIB_USEDEP}] )
	!clip? ( jpeg? ( >=virtual/jpeg-0-r2:0[${MULTILIB_USEDEP}] ) )
	!clip-deps? ( zlib? ( >=sys-libs/zlib-1.2.8-r1[${MULTILIB_USEDEP}] ) )
	python? ( ${PYTHON_DEPS} )
	abi_x86_32? (
