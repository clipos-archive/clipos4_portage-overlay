...
IUSE="+cxx jbig jpeg lzma static-libs test zlib core-deps clip-deps"

RDEPEND="!core-deps? ( jpeg? ( virtual/jpeg:0=[${MULTILIB_USEDEP}] ) )
...
multilib_src_install_all() {
	...
	rm -f "${ED}${CPREFIX:-/usr}"/share/doc/${PF}/{COPYRIGHT,README*,RELEASE-DATE,TODO,VERSION}
}
