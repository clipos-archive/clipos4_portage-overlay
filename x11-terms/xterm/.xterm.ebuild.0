...
# $Header: /var/cvsroot/gentoo-x86/x11-terms/xterm/xterm-285.ebuild,v 1.6 2012/12/17 20:37:02 maekke Exp $
...
IUSE="toolbar truetype unicode Xaw3d clip-deps clip"

COMMON_DEPEND="kernel_linux? ( sys-libs/libutempter )
	kernel_FreeBSD? ( sys-libs/libutempter )
	!clip-deps? ( >=sys-libs/ncurses-5.7-r7 )
	x11-apps/xmessage
	x11-libs/libX11
	x11-libs/libXaw
	x11-libs/libXft
...
pkg_setup() {
	DEFAULTS_DIR="${EPREFIX}${CPREFIX:-/usr}"/share/X11/app-defaults
}
