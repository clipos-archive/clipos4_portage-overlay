...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/wireless-tools/wireless-tools-29.ebuild,v 1.10 2008/08/11 17:29:17 armin76 Exp $

inherit toolchain-funcs multilib eutils verictl2
...
pkg_predeb() {
	...
	doverictld2 /sbin/ifrename er NET_ADMIN - NET_ADMIN n ccsd
	doverictld2 /sbin/iwconfig er NET_ADMIN - NET_ADMIN n ccsd
	doverictld2 /sbin/iwlist er NET_ADMIN - NET_ADMIN n ccsd
	doverictld2 /sbin/iwgetid er NET_ADMIN - NET_ADMIN n ccsd
}
